...
export default function LoginForm() {
  ...
  const onSubmit = (data) => {
    ...
    if (data.email === 'admin@example.com' && data.password === 'admin') {
      login({ id: 1, email: data.email, role: 'admin', name: 'Admin User' })
      navigate('/dashboard')
    } else if (data.email === 'manager@example.com' && data.password === 'manager') {
      login({ id: 2, email: data.email, role: 'manager', name: 'Parking Manager' })
      navigate('/dashboard')
    } else if (data.email === 'driver@example.com' && data.password === 'driver') {
      login({ id: 3, email: data.email, role: 'driver', name: 'John Driver' })
      navigate('/dashboard')
    } else {
